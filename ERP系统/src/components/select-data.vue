			...
			<div style="padding:16px;">
	        	...
	        	<Card>
	        		...
	        		<div slot="title" style="display:flex;justify-content: space-between;align-items: center;">
	        			<h2>需要采购的物品列表</h2>
	        			<Button type="primary" @click="modalShow = true">点击选择物品</Button>
	        		</div>
	        		
	        		<div style="padding:16px;">
	        			<Form class="formInstance" ref="formInstance" :model="purchaseGoods" :show-message="false">
